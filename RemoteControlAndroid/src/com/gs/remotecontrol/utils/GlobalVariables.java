...
public class GlobalVariables {
	...
	public static int INT_DEFAULT_PORT_COMMAND = 1992;// 默认端口
	public static int INT_DEFAULT_PORT_IMG = 1993;// 接受图片的端口号码
	public static int INT_MOUSE_SENSE = 10;
	public static String STRING_HOST_IP = "192.168.1.101";// 默认ip
